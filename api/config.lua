...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("buffbar",    "pbuff",       "shownames",        "1")
  pfUI:UpdateConfig("buffbar",    "pbuff",       "showtimer",        "1")
  pfUI:UpdateConfig("buffbar",    "pbuff",       "vertical",         "0")
  pfUI:UpdateConfig("buffbar",    "pbuff",       "reversegrow",      "0")
  ...
  pfUI:UpdateConfig("buffbar",    "pdebuff",     "shownames",        "1")
  pfUI:UpdateConfig("buffbar",    "pdebuff",     "showtimer",        "1")
  pfUI:UpdateConfig("buffbar",    "pdebuff",     "vertical",         "0")
  pfUI:UpdateConfig("buffbar",    "pdebuff",     "reversegrow",      "0")
  ...
  pfUI:UpdateConfig("buffbar",    "tdebuff",     "shownames",        "1")
  pfUI:UpdateConfig("buffbar",    "tdebuff",     "showtimer",        "1")
  pfUI:UpdateConfig("buffbar",    "tdebuff",     "vertical",         "0")
  pfUI:UpdateConfig("buffbar",    "tdebuff",     "reversegrow",      "0")
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "buffoffsetx",      "0")
    pfUI:UpdateConfig("unitframes", unit,      "buffoffsety",      "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "verticalpowerbar", "0")
  ...
  pfUI:UpdateConfig("castbar",    "player",      "vertical",         "0")
  ...
  pfUI:UpdateConfig("castbar",    "target",      "vertical",         "0")
  ...
  pfUI:UpdateConfig("castbar",    "focus",       "vertical",         "0")
