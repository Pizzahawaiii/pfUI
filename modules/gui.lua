pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Buffs"], T["Player Buff Bar"], function()
      ...
      CreateConfig(nil, T["Show Buff Names"], C.buffbar.pbuff, "shownames", "checkbox")
      CreateConfig(nil, T["Show Buff Timers"], C.buffbar.pbuff, "showtimer", "checkbox")
      CreateConfig(nil, T["Enable Vertical Bars"], C.buffbar.pbuff, "vertical", "checkbox")
      CreateConfig(nil, T["Reverse Grow Direction"], C.buffbar.pbuff, "reversegrow", "checkbox")
    ...
    CreateGUIEntry(T["Buffs"], T["Player Debuff Bar"], function()
      ...
      CreateConfig(nil, T["Show Debuff Names"], C.buffbar.pdebuff, "shownames", "checkbox")
      CreateConfig(nil, T["Show Debuff Timers"], C.buffbar.pdebuff, "showtimer", "checkbox")
      CreateConfig(nil, T["Enable Vertical Bars"], C.buffbar.pdebuff, "vertical", "checkbox")
      CreateConfig(nil, T["Reverse Grow Direction"], C.buffbar.pdebuff, "reversegrow", "checkbox")
    ...
    CreateGUIEntry(T["Buffs"], T["Target Debuff Bar"], function()
      ...
      CreateConfig(nil, T["Show Debuff Names"], C.buffbar.tdebuff, "shownames", "checkbox")
      CreateConfig(nil, T["Show Debuff Timers"], C.buffbar.tdebuff, "showtimer", "checkbox")
      CreateConfig(nil, T["Enable Vertical Bars"], C.buffbar.tdebuff, "vertical", "checkbox")
      CreateConfig(nil, T["Reverse Grow Direction"], C.buffbar.tdebuff, "reversegrow", "checkbox")
    ...
    CreateGUIEntry(T["Castbar"], nil, function()
      ...
      CreateConfig(nil, T["Enable Vertical Player Castbar"], C.castbar.player, "vertical", "checkbox")
      ...
      CreateConfig(nil, T["Enable Vertical Target Castbar"], C.castbar.target, "vertical", "checkbox")
      ...
      CreateConfig(nil, T["Enable Vertical Focus Castbar"], C.castbar.focus, "vertical", "checkbox")
